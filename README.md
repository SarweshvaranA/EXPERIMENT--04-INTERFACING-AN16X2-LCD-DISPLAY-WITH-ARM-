...
int main(void)
{
  ...
  MX_GPIO_Init();
      Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
         ...
         Lcd_cursor(&lcd, 0,1);
         Lcd_string(&lcd, "SARWESHVARAN A");
         Lcd_cursor(&lcd, 1,1);
         Lcd_string(&lcd, "212223230198");
         HAL_Delay(500);
...
<img width="1083" height="759" alt="image" src="https://github.com/user-attachments/assets/5ddcbd56-061e-4a5b-bdb1-a4aa86f4510d" />
...
<img width="1005" height="702" alt="image" src="https://github.com/user-attachments/assets/4a5c8cce-5c54-4eb1-8bdf-1300750d055d" />
